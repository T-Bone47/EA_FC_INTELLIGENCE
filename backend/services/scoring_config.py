...
"CB": {"defending": 18, "standing_tackle": 12, "interceptions": 11,
            ...
            "short_passing": 8, "long_passing": 6, "vision": 5, "composure": 5},
...
TACTICAL_ATTRIBUTE_WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "PRESSING": {"stamina": 18, "aggression": 14, "interceptions": 12,
                 ...
                 "gk_reflexes": 8, "gk_positioning": 6},
    "CROSSING": {"crossing": 22, "curve": 12, "long_passing": 10, "vision": 10,
                 ...
                 "gk_handling": 8, "gk_positioning": 7, "gk_reflexes": 5},
    "LONG_SHOT": {"long_shots": 22, "shot_power": 16, "curve": 10, "finishing": 10,
                  ...
                  "gk_reflexes": 8, "gk_positioning": 7},
    ...
    "BUILD_UP": {"short_passing": 16, "long_passing": 12, "vision": 12,
                 ...
                 "gk_kicking": 10, "gk_positioning": 8},
    ...
    "HIGH_PRESS": {"stamina": 18, "aggression": 12, "interceptions": 10,
                   ...
                   "strength": 6,
                   "gk_reflexes": 8, "gk_positioning": 6, "gk_kicking": 6},
    "MID_BLOCK": {"defensive_awareness": 14, "positioning": 13, "interceptions": 11,
                  ...
                  "gk_positioning": 10, "gk_handling": 7, "gk_reflexes": 6},
    "LOW_BLOCK": {"defensive_awareness": 16, "positioning": 15, "standing_tackle": 13,
                  ...
                  "gk_positioning": 12, "gk_handling": 10, "gk_reflexes": 8, "gk_diving": 6},
    ...
    "SLOW_BUILD_UP": {"short_passing": 16, "composure": 13, "ball_control": 13,
                      ...
                      "strength": 4,
                      "gk_kicking": 8, "gk_positioning": 9},
    "BALANCED": {},   # no tactical demand -> UNKNOWN component
    "CUSTOM": {},     # weights come from requirements.custom_tactics
}

# ---------------------------------------------------------------- GK tactical profiles
# GK-specific tactical attribute weights (only used for GK candidates).
# These replace the outfield tactical weights when candidate.position_primary == 'GK'.
GK_TACTICAL_ATTRIBUTE_WEIGHTS: dict[str, dict[str, float]] = {
    "PACE_ABUSER": {},  # not applicable for GK
    "COUNTER_ATTACK": {"gk_kicking": 20, "gk_positioning": 12, "gk_reflexes": 8},
    "POSSESSION": {"gk_kicking": 22, "gk_positioning": 14, "gk_handling": 10, "gk_reflexes": 8},
    "DRIBBLE_HEAVY": {},  # not applicable for GK
    "PRESSING": {"gk_reflexes": 20, "gk_positioning": 14, "gk_diving": 10, "gk_handling": 8},
    "CROSSING": {"gk_handling": 20, "gk_positioning": 15, "gk_reflexes": 12, "gk_diving": 8},
    "LONG_SHOT": {"gk_reflexes": 22, "gk_positioning": 14, "gk_diving": 12, "gk_handling": 8},
    "DIRECT_PLAY": {"gk_kicking": 20, "gk_positioning": 14, "gk_handling": 10, "gk_reflexes": 8},
    "BUILD_UP": {"gk_kicking": 24, "gk_positioning": 16, "gk_handling": 12, "gk_reflexes": 8},
    "HIGH_PRESS": {"gk_reflexes": 22, "gk_positioning": 14, "gk_diving": 12, "gk_kicking": 8, "gk_handling": 8},
    "MID_BLOCK": {"gk_positioning": 22, "gk_handling": 16, "gk_reflexes": 12, "gk_diving": 10},
    "LOW_BLOCK": {"gk_positioning": 24, "gk_handling": 18, "gk_reflexes": 14, "gk_diving": 12},
    "FAST_BUILD_UP": {"gk_kicking": 22, "gk_positioning": 14, "gk_reflexes": 12, "gk_handling": 8},
    "SLOW_BUILD_UP": {"gk_kicking": 20, "gk_positioning": 18, "gk_handling": 14, "gk_reflexes": 10},
    "BALANCED": {},
    "CUSTOM": {},
}

# GK tactical profile PlayStyles (advisory)
GK_TACTICAL_PROFILE_PLAYSTYLES: dict[str, list[str]] = {
    "PACE_ABUSER": [],
    "COUNTER_ATTACK": ["Long Throw", "Far Throw", "Footwork"],
    "POSSESSION": ["Footwork", "Long Throw", "Far Throw"],
    "DRIBBLE_HEAVY": [],
    "PRESSING": ["Rush Out", "Cross Claimer", "Footwork"],
    "CROSSING": ["Cross Claimer", "Far Reach", "Footwork"],
    "LONG_SHOT": ["Rush Out", "Far Reach", "Acrobatic"],
    "DIRECT_PLAY": ["Long Throw", "Far Throw", "Footwork"],
    "BUILD_UP": ["Footwork", "Long Throw", "Far Throw"],
    "HIGH_PRESS": ["Rush Out", "Cross Claimer", "Footwork"],
    "MID_BLOCK": ["Cross Claimer", "Far Reach", "Block"],
    "LOW_BLOCK": ["Block", "Far Reach", "Cross Claimer", "Footwork"],
    "FAST_BUILD_UP": ["Long Throw", "Far Throw", "Footwork"],
    "SLOW_BUILD_UP": ["Footwork", "Long Throw", "Far Throw"],
    "BALANCED": [],
    "CUSTOM": [],
}
